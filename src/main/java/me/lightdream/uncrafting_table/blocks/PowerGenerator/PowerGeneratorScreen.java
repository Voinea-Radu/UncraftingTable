...
public class PowerGeneratorScreen extends ContainerScreen<PowerGeneratorContainer> {

    private final ResourceLocation GUI = new ResourceLocation(UncraftingTable.MOD_ID, "textures/gui/power-generator-gui.png");

    public PowerGeneratorScreen(PowerGeneratorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
